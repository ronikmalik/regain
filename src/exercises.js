...
export const MOUNTS = {
  ...
  held: {
    id: 'held',
    name: 'Hand-held, light edge grip',
    tag: 'No equipment',
    short: 'Hand-held',
    summary: 'Works without gear, but any change in grip pressure reads as wrist motion. Keep the grip light and identical for the whole set.',
    how: 'Hold the phone upright in the palm as you normally would: bottom edge resting on your little finger, the pads of the other fingers flat on the back, and your thumb resting along the side edge with its tip on the pad in the lower corner. Do not squeeze, do not press with the thumb, and do not let fingers curl over the screen. Grip the edges, not the face.',
    countdown: 3,
    pad: true,
  },
};
