...
export const MOUNTS = {
  ...
  held: {
    ...
    tag: 'No equipment',
    short: 'Hand-held',
    summary: 'Phone lies flat on four straight fingers. The thumb only pins one corner.',
    how: [
      'Hold four fingers straight and together, palm up.',
      'Lay the phone face-up along the fingers, top toward the fingertips.',
      'Pin the lower thumb-side corner with your thumb tip, on the pad.',
      'Keep the fingers straight and still. Do not squeeze.',
    ],
    countdown: 3,
    pad: true,
  },
